...
@copy /y ..\..\TE-USB-Suite\TE_USB_FX2.firmware\ready_for_download\current_te.iic PREPARE_FWU\usb.bin
@copy /y PREPARE_FWU\usb.bin .\
@copy /y PREPARE_FWU\Bootload.ini .\

@rem Generate FWU for LX45
@copy /y TE0630_LX45.bit fpga.bit
@impact -batch etc\bit2bin.cmd
@copy /y fpga.bin TE0630-LX45.bin
...
@copy /y TE0630_LX75.bit fpga.bit
@impact -batch etc\bit2bin.cmd
@copy /y fpga.bin TE0630-LX75.bin
@impact -batch etc\bit2mcs.cmd
...
@copy /y TE0630_LX100.bit fpga.bit
@impact -batch etc\bit2bin.cmd
@copy /y fpga.bin TE0630-LX100.bin
@impact -batch etc\bit2mcs.cmd
...
@copy /y TE0630_lx150.bit fpga.bit
@impact -batch etc\bit2bin.cmd
@copy /y fpga.bin TE0630-LX150.bin
@impact -batch etc\bit2mcs.cmd
